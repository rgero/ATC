...
using Random = UnityEngine.Random;
    ...
    public class AeroplaneAiControl : MonoBehaviour
    {
        ...
        [SerializeField] private float m_LateralWanderDistance = 1;     // The amount that the plane can wander by when heading for a target
        ...
        private bool m_TakenOff = true;                            // Has the plane taken off yet
